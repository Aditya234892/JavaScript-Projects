let apiKey = "9Vvg-u0ZX3L3oblXrntcuwFQpg0Ks18qANEUHe9VKko";
...
async function getDeta() {
    ...
    let url = `https://api.unsplash.com/search/photos?page=${page}&query=${encodeURIComponent(searchQuery)}&client_id=${apiKey}&per_page=20`;
